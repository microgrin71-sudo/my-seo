      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            ...
            blockquote: { borderLeftWidth: '3px', borderLeftColor: '#10b98133', padding: '0 0 0 1.25rem', fontStyle: 'normal', color: theme('colors.neutral.500') },
            ...
            a: { color: '#10b981', textDecoration: 'underline', textDecorationColor: '#10b98144', textUnderlineOffset: '3px', transition: 'text-decoration-color 0.2s' },
